...
if [ $# != 2 ]; then
  ...
  echo "e.g.:"
  echo " $0 data/train data/train_volume"
  exit 1
fi
...
volume_perturb_done=`head -n100 $srcdir/wav.scp | python -c "
import sys, re
