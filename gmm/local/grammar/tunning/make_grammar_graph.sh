...
if [ $stage -le 2 ]; then
  ...
  cat ${ori_lm} | arpa2fst --disambig-symbol=#0 \
...
# 0    1    开始  开始
# 0    1   <eps>  <eps>  4.0
# 1    2    播放   播放   0.69314718055994
# 1    2    提醒   提醒  0.69314718055994
# 1    2    <eps>  <eps>  5.0
# 2    3    结束   结束  0.69314718055994
# 2  0.69314718055994
# 3
# EOF
...
#   cat ${location_lm} | arpa2fst --disambig-symbol=#0 \
#              --read-symbol-table=$lang/words.txt - $lang/G.fst
#   cat <<EOF | fstcompile --isymbols=$lang/words.txt --osymbols=$lang/words.txt | \
#      fstarcsort --sort_type=ilabel >$lang/G.fst
# 0    1    开   开
# 0    1    <eps>   <eps>  4.0
# 1    2    #nonterm:location  <eps>
# 1    2    播放   播放   0.69314718055994
# 1    2    提醒   提醒  0.69314718055994
# 2    3    结   结  0.69314718055994
# 2  0.69314718055994
# 3
# EOF
